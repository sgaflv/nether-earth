...
/* Each glyph is a flat list of polylines (strokes). The pen starts     */
/* "up" at the beginning of each glyph (this is assumed, not stored),   */
/* so the first point of the glyph is a move-to (pen lands without      */
/* drawing). Each subsequent point connects with a straight line from   */
/* the previous point (the previous end-point is reused as the start).  */
/* A PEN_UP command begins a new stroke within a multi-stroke glyph;    */
/* the first point after it is a move-to. An END_GLYPH command          */
/* terminates the glyph.                                                */
/*                                                                      */
/* PEN_UP and END_GLYPH expand to a full coordinate pair (value,value), */
/* i.e. the sentinel is written once and applied to both the X and Y    */
/* coordinates simultaneously.                                          */
#define PEN_UP_VAL   (-1000)
#define END_GLYPH_VAL (-2000)

#define PEN_UP   PEN_UP_VAL,PEN_UP_VAL
#define END_GLYPH END_GLYPH_VAL,END_GLYPH_VAL

#define NUL {END_GLYPH}

/* Space: */ 
static const short glyph_space[] = {
    END_GLYPH
};
...
static const short glyph_dollar[] = {
    40,108,40,-8,
    PEN_UP,
    60,90,24,90,16,82,16,62,24,54,56,46,64,38,64,16,56,8,20,8,
    PEN_UP,
    16,62,56,54,
    END_GLYPH
};
...
static const short glyph_ampersand[] = {
    60,80,52,92,32,100,20,92,20,78,28,66,56,38,64,24,64,12,56,4,32,4,20,12,20,28,28,40,60,72,
    PEN_UP,
    44,52,64,28,
    END_GLYPH
};
...
static const short glyph_lparen[] = {
    52,100,40,88,32,70,28,50,32,30,40,12,52,0,
    END_GLYPH
};

/* Right parenthesis ) */
static const short glyph_rparen[] = {
    28,100,40,88,48,70,52,50,48,30,40,12,28,0,
    END_GLYPH
};
...
static const short glyph_0[] = {
    20,100,60,100,60,0,20,0,20,100,
    PEN_UP,
    20,0,60,100,
    END_GLYPH
};
...
static const short glyph_2[] = {
    20,100,60,100,60,65,20,0,60,0,
    END_GLYPH
};

/* Digit 3 */
static const short glyph_3[] = {
    20,100,60,100,60,55,20,55,
    PEN_UP,
    60,55,60,0,20,0,
    END_GLYPH
};
...
static const short glyph_5[] = {
    60,100,20,100,20,55,52,55,60,47,60,8,52,0,20,0,
    END_GLYPH
};

/* Digit 6 */
static const short glyph_6[] = {
    60,100,20,100,20,0,60,0,60,55,20,55,
    END_GLYPH
};
...
static const short glyph_9[] = {
    20,0,60,0,60,100,20,100,20,55,60,55,
    END_GLYPH
};
...
static const short glyph_question[] = {
    20,80,52,80,60,72,60,60,52,52,40,44,40,28,
    PEN_UP,
    40,8,40,8,
    END_GLYPH
};
...
static const short glyph_at[] = {
    28,90,52,90,64,78,64,22,52,10,24,10,12,22,12,78,24,90,
    PEN_UP,
    28,28,48,28,52,32,52,68,48,72,28,72,24,68,24,32,28,28,
    PEN_UP,
    52,72,52,40,60,32,
    END_GLYPH
};
...
static const short glyph_B[] = {
    16,100,16,0,
    PEN_UP,
    16,100,50,100,60,90,60,65,50,55,16,55,
    PEN_UP,
    50,55,60,45,60,10,50,0,16,0,
    END_GLYPH
};
...
static const short glyph_D[] = {
    16,100,16,0,
    PEN_UP,
    16,100,50,100,60,90,60,10,50,0,16,0,
    END_GLYPH
};
...
static const short glyph_b[] = {
    16,100,16,4,
    PEN_UP,
    16,45,24,53,52,53,60,45,60,12,52,4,24,4,16,12,
    END_GLYPH
};
...
static const short glyph_d[] = {
    60,100,60,4,
    PEN_UP,
    60,45,52,53,24,53,16,45,16,12,24,4,52,4,60,12,
    END_GLYPH
};
...
static const short glyph_e[] = {
    16,32,60,32,
    PEN_UP,
    16,32,16,12,24,4,52,4,60,12,
    PEN_UP,
    16,32,24,65,52,65,60,57,60,32,
    END_GLYPH
};

/* Lowercase f */
static const short glyph_f[] = {
    56,100,36,100,28,92,28,12,36,4,44,4,
    PEN_UP,
    16,65,48,65,
    END_GLYPH
};
...
/* Lowercase g */
static const short glyph_g[] = {
    24,65,52,65,60,57,60,12,52,4,24,4,16,12,16,57,24,65,
    PEN_UP,
    16,-20,24,-28,52,-28,60,-20,60,4,
    END_GLYPH
};
...
static const short glyph_m[] = {
    12,4,12,65,
    PEN_UP,
    12,45,20,53,32,53,40,45,40,4,
    PEN_UP,
    40,45,48,53,60,53,68,45,68,4,
    END_GLYPH
};
...
static const short glyph_r[] = {
    16,4,16,65,
    PEN_UP,
    16,45,24,53,40,53,48,45,
    END_GLYPH
};

/* Lowercase s */
static const short glyph_s[] = {
    60,65,24,65,16,57,16,40,24,32,52,32,60,24,60,12,52,4,16,4,
    END_GLYPH
};

/* Lowercase t */
static const short glyph_t[] = {
    32,100,32,12,40,4,52,4,
    PEN_UP,
    16,65,48,65,
    END_GLYPH
};
...
/* Lowercase u */
static const short glyph_u[] = {
    16,65,16,12,24,4,52,4,60,12,60,65,
    END_GLYPH
};
...
static const short glyph_lbrace[] = {
    52,100,40,100,32,92,32,58,24,50,32,42,32,8,40,0,52,0,
    END_GLYPH
};
...
static const short glyph_rbrace[] = {
    28,100,40,100,48,92,48,58,56,50,48,42,48,8,40,0,28,0,
    END_GLYPH
};

/* Tilde ~ */
static const short glyph_tilde[] = {
    16,45,24,55,36,55,48,35,56,25,64,25,
    END_GLYPH
};
